            ...
            <>
              {username ? (
                <Link
                  ...
                  className="max-w-[9rem] truncate font-medium text-zinc-600 transition-colors hover:text-foreground sm:max-w-[12rem] dark:text-zinc-400 dark:hover:text-zinc-100"
                >
                  {displayName}
                </Link>
              ) : (
